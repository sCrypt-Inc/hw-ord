...
import { FtCounter } from '../src/contracts/ftCounter'
...
describe('Test SmartContract `FtCounter`', () => {
    ...
    before(async () => {
        ...
        await FtCounter.deploy(getDefaultSigner(), tick, max, lim)
    })

    it('mint all and transfer 1 token to a receiver in a call.', async () => {
